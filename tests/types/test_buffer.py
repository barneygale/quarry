...
pack_unpack_vectors = [
    ...
    ("iiii", b"\x00\x00\x00\x00\x7F\xFF\xFF\xFF"
     b"\x80\x00\x00\x00\xFF\xFF\xFF\xFF", (0, 2147483647, -2147483648, -1)),
...
entity_metadata_vectors = [
    (OrderedDict(
        (((0, 0), 0), ((1, 1), 1), ((2, 2), 2.0), ((3, 3), 'three'),
         ((4, 4), Message({'text':
                           'four'})), ((5, 5),
                                       Message({'text': 'five'})), ((6, 6), {
                                           'count':
                                           1,
                                           'item':
                                           267,
         ...
         ((9, 9), (9, 9, 9)), ((10, 10), (10, 10, 10)), ((11, 11), 'north'),
         ((12, 12), UUID.from_bytes(uuid_vector)), ((13, 13), 13),
         ((14, 14), TagRoot({'foo': TagString('bar')})))), b'\x00\x00\x00'
     b'\x01\x01\x01'
